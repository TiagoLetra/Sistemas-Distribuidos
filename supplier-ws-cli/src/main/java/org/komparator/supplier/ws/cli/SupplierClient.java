...
import org.komparator.security.handler.NonceSenderHandler;
import org.komparator.security.handler.NonceReceiverHandler;
/**
 * Client port wrapper.
 *
	...
	private void createStub() {
		...
		if (wsURL != null) {
			if (verbose)
				...
				if(wsName!=null){
					requestContext.put(NonceSenderHandler.REQUEST_PROPERTY, wsName);
				}
		}
	}
