...
public class EncriptHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public static final String CLASS_NAME = EncriptHandler.class.getSimpleName();
		...
		Boolean outbound = (Boolean) smc.get(MessageContext.MESSAGE_OUTBOUND_PROPERTY);
			...
			// outbound message
				...
				if (secretArgument.length() != 0){
					...
					Certificate cert=CryptoUtil.getCertificateFromString(caclient.getCertificate(CERT_NAME));
					...
					byte[] cipheredArgument = CryptoUtil.asymCipher(secretArgument.getBytes(),PUBLICEKEY);
